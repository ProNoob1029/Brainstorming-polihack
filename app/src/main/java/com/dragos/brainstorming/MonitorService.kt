...
//        val endTime = System.currentTimeMillis() - 1000 * 60 * 60 * 22
//        val startTime = endTime - 1000 * 60 * 60 * 24
//
//        val instaUsage = usageStatsManager
//            .queryAndAggregateUsageStats(startTime, endTime)["com.instagram.android"]
//            ?: return

        val stat = getDailyStats(usageStatsManager).first { it.packageName == "com.instagram.android" }

        //Log.d("Current App", "stat count: ${stat.count()}")
